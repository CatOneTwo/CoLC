...
from opencood.data_utils.datasets.early_kd_fusion_dataset import getEarlykdFusionDataset
from opencood.data_utils.datasets.early_kd_v2vreal_fusion_dataset import getEarlykdv2vrealFusionDataset
...
from opencood.data_utils.datasets.intermediate_v2vreal_fusion_dataset import getIntermediatev2vrealFusionDataset
from opencood.data_utils.datasets.intermediate_downsample_fusion_dataset import getIntermediatedownsampleFusionDataset
from opencood.data_utils.datasets.single_dataset import getSingleFusionDataset
from opencood.data_utils.datasets.early_seg_dataset import getSegearlyFusionDataset
...
from opencood.data_utils.datasets.basedataset.v2vreal_basedataset import V2VREALBaseDataset
...
def build_dataset(dataset_cfg, visualize=False, train=True):
    ...
    assert fusion_name in ['late', 'intermediate', 'intermediate2stage', 'early','intermediatev2vreal', 'earlykd',  'earlykdv2vreal', 'intermediatedownsample','single','seg', 'segcav','seglist','segearly']
    assert dataset_name in ['opv2v', 'v2xsim', 'dairv2x', 'v2xset','v2vreal','v2xreal']
