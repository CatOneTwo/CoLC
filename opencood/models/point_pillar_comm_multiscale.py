...
class PointPillarCommMultiscale(nn.Module):
    ...
    def forward(self, data_dict):
        ...
        if 'nei_processed_lidar' in data_dict and record_len.sum() > 1:
            ...
            N,C0,H0,W0 = spatial_features_2d_single.size()
            ...
            spatial_features_2d_single[1:] = x_nei_new[1:]
        ...
        # v2xsim三层特征 [N, 64, 80, 80], [N, 128, 40, 40], [N, 256, 20, 20]
        # dairv2x 三层特征
        ...
        if 'nei_processed_lidar' in data_dict and record_len.sum() > 1:
            ...
            for i in range(len(feature_list)):
                spatial_features_2d = feature_list[i]
                ...
                feature_list[i] = spatial_features_2d
        ...
        for i, fuse_module in enumerate(self.fusion_net):
            ...
            x_out, communication_rates = fuse_module(feature_i, psm_single,
                                                record_len, normalized_affine_matrix, req_mask,)
            # print(x_out.shape, communication_rates)
