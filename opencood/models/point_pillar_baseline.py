...
from opencood.models.fuse_modules.fusion_in_one import MaxFusion, AttFusion, DiscoFusion, V2VNetFusion, V2XViTFusion, When2commFusion, CoBEVT
...
class PointPillarBaseline(nn.Module):
    ...
    def forward(self, data_dict):
        ...
        output_dict.update({'feat': fused_feature})
